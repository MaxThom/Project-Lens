...
namespace WorkerService
{
    public class WallpaperService : IWallpaperService
    {
        ...
        public void SetWallpapers(List<Picture> pictures, int monitorsCount)
        {
        ...
        private static void CreateBackgroundImage(Dictionary<string, Image> imageFiles)
        {
            ...
            using (var virtualScreenBitmap = new Bitmap((int.SystemParameters.VirtualScreenWidth, (int)System.Windows.SystemParameters.VirtualScreenHeight))
            {
        ...
        private SystemParametersInfo(SPI_SETDESKWALLPAPER, 0u, defaultBackgroundFile, SPIF_UPDATEINIFILE);
    }
